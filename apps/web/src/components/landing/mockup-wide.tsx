...
export function MockupWideView() {
  return (
    <div className="flex h-full flex-col bg-white">
      ...
      <div className="flex items-center gap-1 border-b border-[#c9c9c9] px-3 py-4 sm:gap-2 sm:px-6">
        <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full text-[#333333]/80">
          <ChevronLeft size={28} strokeWidth={2} />
        </span>
        <h3 className="ml-2 min-w-0 flex-1 truncate text-left text-[19px] font-medium leading-none tracking-[-0.01em] text-[#333333]/80 sm:ml-3 sm:text-[24px]">
      ...
      <div className="flex flex-col gap-4 px-4 pt-5 sm:gap-5 sm:px-8 sm:pt-6">
        <div className="flex justify-end">
          <div className="max-w-[85%] rounded-[20px] border border-[#d7d7d7] bg-white px-5 py-4 sm:max-w-[65%] sm:px-5 sm:py-4">
            <p className="text-[15px] font-normal leading-[1.45] tracking-[-0.005em] text-[#1a1a1a] sm:text-[17px]">
